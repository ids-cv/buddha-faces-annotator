...
def normalize(points):
    ...
    return centred / centred.max(), np.mean(points, axis=0), centred.max()
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, config=None, filename=None, output=None, output_file=None, output_dir=None):
        ...
        self.settings = QtCore.QSettings("", "labelme")
    ...
    def update_from_shapes(self):
        ...
        for item in self.labelList:
            labels[item.shape().label] = []
            for point in item.shape().points:
                labels[item.shape().label] += [[point.x(), point.y()]]
        points = np.asarray(labels['jaw_line'] + labels['right_eyebrow'] + labels['left_eyebrow'] + labels['nose'] +
    ...
    def view_from_model(self):
        ...
        view = {'jaw_line': view[:17],
                ...
                'nose': view[27:36],
                'left_eye': view[42:48],
                'left_eyebrow': view[22:27]
                }
        shapes = [
            {'label': 'jaw_line', 'points': view['jaw_line'], 'shape_type': 'linestrip', 'flags': {}, 'group_id': None,
             'other_data': {}},
            {'label': 'nose', 'points': view['nose'], 'shape_type': 'linestrip', 'flags': {}, 'group_id': None,
             'other_data': {}},
            {'label': 'mouth', 'points': view['mouth'], 'shape_type': 'linestrip', 'flags': {}, 'group_id': None,
             'other_data': {}},
            {'label': 'left_eye', 'points': view['left_eye'], 'shape_type': 'linestrip', 'flags': {}, 'group_id': None,
             'other_data': {}},
            {'label': 'left_eyebrow', 'points': view['left_eyebrow'], 'shape_type': 'linestrip', 'flags': {},
             'group_id': None, 'other_data': {}},
            {'label': 'right_eye', 'points': view['right_eye'], 'shape_type': 'linestrip', 'flags': {},
             'group_id': None, 'other_data': {}},
            {'label': 'right_eyebrow', 'points': view['right_eyebrow'], 'shape_type': 'linestrip', 'flags': {},
             'group_id': None, 'other_data': {}}
        ]
        return shapes
